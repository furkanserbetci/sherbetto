    ...
    <footer className="bg-[var(--primary)] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-semibold text-lg mb-4">Hızlı Erişim</h4>
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/urunler" className="text-gray-300 hover:text-[var(--accent)] transition-colors">
                  Ürünler
                </Link>
              </li>
              <li>
                <Link href="/hakkimizda" className="text-gray-300 hover:text-[var(--accent)] transition-colors">
                  Hakkımızda
                </Link>
              </li>
              <li>
                <Link href="/iletisim" className="text-gray-300 hover:text-[var(--accent)] transition-colors">
                  İletişim
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Sherbetto. Tüm hakları saklıdır.</p>
        </div>
      </div>
    </footer>
  );
