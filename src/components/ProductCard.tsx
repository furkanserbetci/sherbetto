  ...
  return (
    <div className="bg-white rounded-2xl overflow-hidden border border-[var(--border-light)] hover:border-[var(--accent-light)] hover:shadow-xl transition-all duration-500 group">
      ...
      <Link href={`/${locale}/products/${product.id}`} className="block relative h-56 overflow-hidden bg-gray-100">
        ...
        />
        {product.featured && (
          <span className="absolute top-4 left-4 bg-[var(--primary)] text-white text-[10px] font-medium px-3 py-1.5 rounded-full uppercase tracking-wider">
            {t("products.featured")}
          </span>
        )}
      </Link>
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <a
            ...
            className="bg-[var(--primary)] hover:bg-gray-800 text-white px-4 py-2 rounded-full text-sm font-medium transition-colors duration-200 flex items-center gap-2"
          >
