    ...
    <>
      ...
      <section className="py-24 bg-[var(--background)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-16">
            ...
            >
              {t("common.viewAll") === "common.viewAll" ? "Tüm Ürünleri Gör" : t("common.viewAll")}
            </Link>
          </div>
        </div>
      </section>
          ...
          <div className={`grid grid-cols-1 md:grid-cols-3 gap-8 ${isRTL ? "rtl" : ""}`}>
            ...
            <div className="text-center p-10 rounded-2xl border border-[var(--border-light)] hover:border-[var(--accent-light)] transition-all duration-500">
              ...
              <h3 className="font-[family-name:var(--font-cormorant)] text-xl font-medium mb-4 text-[var(--primary)]">
                {t("whyUs.feature1Title") || "%100 Doğal Malzeme"}
              </h3>
              <p className="text-[var(--foreground-muted)] leading-relaxed">
                {t("whyUs.feature1Desc") || "Tüm ürünlerimizde en kaliteli ve doğal malzemeler kullanılır. Katkı maddesi yoktur."}
              </p>
            </div>
            ...
            <div className="text-center p-10 rounded-2xl border border-[var(--border-light)] hover:border-[var(--accent-light)] transition-all duration-500">
              ...
              <h3 className="font-[family-name:var(--font-cormorant)] text-xl font-medium mb-4 text-[var(--primary)]">
                {t("whyUs.feature2Title") || "Günlük Taze Üretim"}
              </h3>
              <p className="text-[var(--foreground-muted)] leading-relaxed">
                {t("whyUs.feature2Desc") || "Her gün taze taze üretim yapılır. Siparişleriniz en taze haliyle elinize ulaşır."}
              </p>
            </div>
            ...
            <div className="text-center p-10 rounded-2xl border border-[var(--border-light)] hover:border-[var(--accent-light)] transition-all duration-500">
              ...
              <h3 className="font-[family-name:var(--font-cormorant)] text-xl font-medium mb-4 text-[var(--primary)]">
                {t("whyUs.feature3Title") || "Hızlı Teslimat"}
              </h3>
              <p className="text-[var(--foreground-muted)] leading-relaxed">
                {t("whyUs.feature3Desc") || "Mersin ve çevre illere aynı gün teslimat. Özenli paketleme ile güvenli ulaşım."}
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-gradient-to-b from-[var(--primary)] to-[#0a0a0a] text-white">
        <div className={`max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center ${isRTL ? "rtl" : ""}`}>
          <span className="text-[var(--accent-light)] text-xs font-medium uppercase tracking-[0.2em] mb-6 block">
            {t("common.order") || "Sipariş"}
          </span>
          <h2 className="font-[family-name:var(--font-cormorant)] text-3xl md:text-5xl font-medium mb-6 tracking-tight">
            {t("cta.title") || "Siparişleriniz İçin Bizi Arayın"}
          </h2>
          <p className="text-gray-400 text-lg mb-10 font-light">
            {t("cta.subtitle") || "WhatsApp üzerinden kolayca sipariş verebilir, sorularınızı sorabilirsiniz."}
          </p>
          <a
          ...
          >
            ...
            {t("cart.orderViaWhatsapp") || "WhatsApp ile Sipariş Ver"}
          </a>
        </div>
      </section>
      ...
      <section className="py-24 bg-[var(--background)]">
        <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center ${isRTL ? "rtl" : ""}`}>
          <span className="text-[var(--accent)] text-xs font-medium uppercase tracking-[0.2em] mb-4 block">
            {locale === "ar" ? "وسائل التواصل" : locale === "en" ? "Social Media" : "Sosyal Medya"}
          </span>
          <h2 className="font-[family-name:var(--font-cormorant)] text-3xl md:text-5xl font-medium text-[var(--primary)] mb-5 tracking-tight">
            {locale === "ar"
          ...
          <p className="text-[var(--foreground-muted)] mb-10">
            {locale === "ar"
              ? "لأحدث منتجاتنا وعروضنا @sherbettokunefe"
              : locale === "en"
              ? "For our latest products and offers @sherbettokunefe"
